...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/barisyilmaz/Library/Application Support/luaglider2/dev";local SOCKET_PORT=37667;local GLIDER_MAIN_FOLDER= "/Users/barisyilmaz/Development/Deneysel/DDM";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
